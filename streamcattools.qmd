...
![](C:/Users/RHill04/WorkFolder/Lixo/sfs2024workshop/figures/streamcattools-med-dpi.png){#fig-foo height="192px" width="166.08px" fig-align="left"}
...
Let's revisit the Calapooia watershed and extract % row crop for 2019: 
...
![Geospatial framework of the StreamCat Dataset](C:/Users/RHill04/WorkFolder/Lixo/sfs2024workshop/figures/geospatialframework.png){#fig-foo height="312px" width="480px" fig-align="left"}
...
![Riparian buffers (red) of NHD stream lines (white) and on-network NLCD water pixels (blue).](C:/Users/RHill04/WorkFolder/Lixo/sfs2024workshop/figures/riparianbuffer.png){#fig-foo height="471px" width="480px" fig-align="left"}
...
![Example of off-network lakes (opaque with black outline) and their local catchments (semi-transparent). Numbers within lakes are unique identifiers and arrows indicate the direction of hydrologic connection among lake catchments. Hydrologic connections among lake catchments can be represented with a topology table. Figure from Hill et al. (2018).](C:/Users/RHill04/WorkFolder/Lixo/sfs2024workshop/figures/offnetwork.png){#fig-foo height="522px" width="897px" fig-align="left"}

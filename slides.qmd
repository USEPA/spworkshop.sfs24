...
3. (Optional) Download the workshop slides and/or code (instructions in the workbook's "Welcome" section)
...
* Copy code snippets from the workbook
* Download slides-code.R from GitHub
* Code in real-time
...
include_graphics(here("figures", "tdep.png"))
```
...
include_graphics(here("figures", "tdep_residuals.png"))
```
...
include_graphics(here("figures", "tdep_nonspatial.png"))
```
...
include_graphics(here("figures", "tdep_spatial.png"))
```
...
# Read in lakes data from data package
data("cond_nla_data")
```
...
* [https://usepa.github.io/spmodel/](https://usepa.github.io/spmodel/)
* [https://usepa.github.io/StreamCatTools/](https://usepa.github.io/StreamCatTools/)
* Questions?

...
![Image from: inaturalist.org](https://inaturalist-open-data.s3.amazonaws.com/photos/10992679/original.jpg){height="25%" width="25%" fig-align="left"}
...
![](C:/Users/RHill04/WorkFolder/Lixo/sfs2024workshop/figures/finsyncR.png){#fig-foo height="192px" width="166.08px" fig-align="left"}
...
tmn_prd <-
  ...
  mutate(COMID = pourpoints$comid,
         TMEANPRISMXXXXPT = PRISM_tmean_stable_4kmM3_201907_bil + PRISM_tmean_stable_4kmM3_201908_bil) |> 

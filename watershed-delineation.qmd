...
Outside of the U.S., these tools are not available. However, it is still possible to delineate a custom watershed from raw DEM data with help from the `whitebox` R package. This [book](https://vt-hydroinformatics.github.io/rgeowatersheds.html) by J.P. Gannon has instructions on how to prepare a DEM and provide catchment pourpoints for delineation. 

...
We highly recommend that you follow along and execute code on your personal laptop. However, if you would prefer, you may follow along with a workbook we will make available prior to the workshop that contains all of the necessary code and outpupt.
...
## How to follow along with materials

To follow along, you can copy code snippets from the rendered book site and paste into your code files in RStudio. We will provide a link to the workshop book before the meeting.

## R projects

We highly recommend that you create an R project to contain the code and work related to this workshop. Doing so will greatly simplify paths to data and the execution of code. 

If you are not in the practice of using R projects, please read this section of Hadley Wickham's book [R for Data Science](https://r4ds.hadley.nz/workflow-scripts.html#projects) and create a project on your laptop for this workshop. 
